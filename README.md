...
- The content list api will be sorted by the user interaction which includes sorting by number of likes followed by number of reads. The books which has not any interaction
will be sorted by their primary key.
